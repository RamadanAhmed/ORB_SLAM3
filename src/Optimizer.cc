...
void Optimizer::FullInertialBA(Map *pMap, int its, const bool bFixLocal, const long unsigned int nLoopId, bool *pbStopFlag, bool bInit, float priorG, float priorA, Eigen::VectorXd *vSingVal, bool *bHess)
{
    ...
    using BaLinearSolver = g2o::LinearSolverEigen<g2o::BlockSolverX::PoseMatrixType>;
    linearSolver = g2o::make_unique<BaLinearSolver>();
...
int Optimizer::PoseOptimization(Frame *pFrame)
{
    ...
    g2o::SparseOptimizer optimizer;
    std::unique_ptr<g2o::BlockSolver_6_3::LinearSolverType> linearSolver;
    using BaLinearSolver = g2o::LinearSolverDense<g2o::BlockSolver_6_3::PoseMatrixType>;
    linearSolver = g2o::make_unique<BaLinearSolver>();
...
{   
    ...
    using BaLinearSolver = g2o::LinearSolverEigen<g2o::BlockSolver_7_3::PoseMatrixType>;
    linearSolver = g2o::make_unique<BaLinearSolver>();
...
int Optimizer::OptimizeSim3(KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches1, g2o::Sim3 &g2oS12, const float th2, const bool bFixScale)
{
    g2o::SparseOptimizer optimizer;
    std::unique_ptr<g2o::BlockSolverX::LinearSolverType> linearSolver;
    using BaLinearSolver = g2o::LinearSolverDense<g2o::BlockSolverX::PoseMatrixType>;
    linearSolver = g2o::make_unique<BaLinearSolver>();
